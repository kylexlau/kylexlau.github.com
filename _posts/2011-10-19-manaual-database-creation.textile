...
最权威的参考文档是MOS的文档Doc ID "240052.1":mos1 和 Doc ID "137288.1":mos2 。
...
CREATE TABLESPACE USERS DATAFILE '/dev/rdb_users01' SIZE 8190M REUSE;
...
{% highlight sql%}
srvctl add database -d dcs -o $ORACLE_HOME -p /dev/rdb_spfile
srvctl add instance -d dcs -i dcs1 -n dcsdb1
srvctl add instance -d dcs -i dcs2 -n dcsdb2
{% endhighlight %}
